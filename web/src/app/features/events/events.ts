...
export class Events {
  ...
  columns = computed<Column<Row>[]>(() => [
    { key: 'number', header: '#', value: (r) => r.number, numeric: true, link: (r) => this.div.link('events', r.id) },
    { key: 'title', header: 'Event', value: (r) => r.title, link: (r) => this.div.link('events', r.id) },
